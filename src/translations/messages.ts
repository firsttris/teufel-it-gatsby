export const messages: any = {
  de: {
    ...
    PRIVACY_USE_OF_ANALYTICS: 'Verwendung von Google Analytics',
    PRIVACY_GOOGLE_ANALYTICS_TEXT1:
    ...
    PRIVACY_GOOGLE_ANALYTICS_TEXT2:
    ...
    PRIVACY_COOKIE_TEXT1:
      'Diese Webseite hat selbst keine Cookies implementiert. Allerdings verwendet diese Webseite Services wie \
     Cloudflare oder Google Analytics die Cookies einsetzen. Dazu werden kleine Textdateien in relation zu dieser \
     Website auf ihrem Computer gespeichert.',
    PRIVACY_COOKIE_TEXT2:
  ...
  en: {
    ...
    PRIVACY_USE_OF_ANALYTICS: 'Use of Google Analytics',
    PRIVACY_GOOGLE_ANALYTICS_TEXT1:
      'This website uses Google Analytics, a web analytics service provided by Google Inc. (following: Google). Google \
                 Analytics uses so-called "cookies", ie text files that are stored on your computer and the one \
                 Analysis of the use of the website by you. The information generated by the cookie about \
                 Your use of this website is usually transmitted to a Google server in the US and there \
                 saved. Due to the activation of IP anonymization on these websites, your IP address will be changed by \
                 However, Google within Member States of the European Union or in other Contracting States of the \
                 Agreement on the European Economic Area previously shortened. Only in exceptional cases will the full \
                 IP address to a Google server in the United States and shortened there.',
    PRIVACY_GOOGLE_ANALYTICS_TEXT2:
